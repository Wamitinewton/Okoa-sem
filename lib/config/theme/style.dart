...
final _darkColorScheme = ColorScheme(
  ...
  primary: _primary,
  onPrimary: _lightest,
  primaryContainer: _primary.withValues(alpha: 51),
  onPrimaryContainer: _lightest,
  // Secondary
  secondary: _secondary,
  onSecondary: _lightest,
  secondaryContainer: _secondary.withValues(alpha: 51),
  onSecondaryContainer: _lightest,

  // Tertiary
  tertiary: _tertiary,
  onTertiary: _lightest,
  tertiaryContainer: _tertiary.withValues(alpha: 51),
...
ThemeData _getTheme() {
  ...
  return ThemeData(
    ...
    textSelectionTheme: TextSelectionThemeData(
      ...
      selectionColor: _lightest.withValues(alpha: 51),
